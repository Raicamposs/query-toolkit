...
import { SerialParamSchema } from './serial-params';

describe('SerialParamSchema', () => {
  it('should return serial number', () => {
    const value = 163;

    const parsed = SerialParamSchema.parse(value);
  ...
  it('should return a error', () => {
    ...
    expect(() => SerialParamSchema.parse(value)).toThrowError();
  });

  it('should return a error for zero number', () => {
    const value = {
      equals: 0,
    };
    expect(() => SerialParamSchema.parse(value)).toThrowError();
  ...
  it('should return a error for negative number', () => {
    const value = {
      equals: -2,
    };
    expect(() => SerialParamSchema.parse(value)).toThrowError();

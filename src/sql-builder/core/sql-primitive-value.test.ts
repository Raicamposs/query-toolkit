  ...
  describe('toSql', () => {
    describe('string values', () => {
      it('should format simple string with quotes', () => {
        const value = new SqlPrimitiveValue('test');
        expect(value.toSql()).toBe("'test'");
      });

      it('should escape single quotes by doubling them', () => {
        const value = new SqlPrimitiveValue("O'Brien");
        expect(value.toSql()).toBe("'O''Brien'");
      });

      it('should escape backslashes', () => {
        const value = new SqlPrimitiveValue('path\\to\\file');
        expect(value.toSql()).toBe("'path\\\\to\\\\file'");
      });

      it('should remove null bytes', () => {
        const value = new SqlPrimitiveValue('test\0value');
    ...
    describe('boolean values', () => {
      it('should format true', () => {
        const value = new SqlPrimitiveValue(true);
        expect(value.toSql()).toBe('true');
      });

      it('should format false', () => {
        const value = new SqlPrimitiveValue(false);
    ...
    describe('date values', () => {
      it('should format date in ISO format', () => {
        ...
        const value = new SqlPrimitiveValue(date);
    ...
    describe('null and undefined', () => {
      it('should return undefined for null', () => {
        const value = new SqlPrimitiveValue(null);
        expect(value.toSql()).toBeUndefined();
      });

      it('should return undefined for undefined', () => {
        const value = new SqlPrimitiveValue(undefined);
        expect(value.toSql()).toBeUndefined();
      });
    });
  });
  ...
  describe('type checking methods', () => {
    describe('isString', () => {
      ...
      it('should return false for date', () => {
        const value = new SqlPrimitiveValue(new Date());
        expect(value.isString()).toBe(false);
      });
    });
    ...
    describe('isDate', () => {
      ...
      it('should return false for string', () => {
        const value = new SqlPrimitiveValue('2024-01-15');
    ...
    describe('isValidDate', () => {
      ...
      it('should return false for invalid date string', () => {
        const value = new SqlPrimitiveValue('not a date');

...
4. **Tipagem Estrita**: Evite `any`. Mantenha o sistema fortemente tipado para que o TypeScript guie o desenvolvedor no uso correto da ferramenta. Nunca utilize asserções de tipo forçadas/evasivas (ex: `as  Type`), pois elas mascaram bugs e quebram a integridade dos contratos de classes e interfaces.
